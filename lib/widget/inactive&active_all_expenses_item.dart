  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          AllExpensesItemHeader(img: allExpensesItemModel.image),
          const SizedBox(
            height: 34,
          ),
          FittedBox(
      ...
      child: Column(
        ...
        children: [
          AllExpensesItemHeader(
            img: allExpensesItemModel.image,
            bgColor: Colors.white.withOpacity(0.1000000),
          ...
          FittedBox(
            ...
            child: Text(
              allExpensesItemModel.price,
              style:
                  Styles.styleSemiBold24(context).copyWith(color: Colors.white),
            ),
          )
        ],
      ),
